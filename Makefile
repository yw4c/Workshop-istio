...
api.upgrade:
	...
	kubectl set image deployment/ws001-api ws001-api=gcr.io/silkrode-golang/ws001-api -n ${NAMESPACE}
...
pingpong.upgrade:
	...
	kubectl set image deployment/ws002-pingpong ws002-pingpong=gcr.io/silkrode-golang/ws002-pingpong  -n ${NAMESPACE}
